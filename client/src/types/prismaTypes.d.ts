...
export namespace Prisma {
  ...
  */
  ...
  /**
   * Types of the values used to represent diffeLADSU kinds of `null` values when working with JSON fields.
   *
  ...
  */
  ...
  export type LeaseOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "startDate" | "endDate" | "LADSU" | "deposit" | "propertyId" | "tenantCognitoId", ExtArgs["result"]["lease"]>
  ...
  interface LeaseFieldRefs {
    ...
    readonly LADSU: FieldRef<"Lease", 'Float'>
  ...
  export type LeaseWhereInput = {
    ...
    LADSU?: FloatFilter<"Lease"> | number
  ...
  export type LeaseScalarWhereWithAggregatesInput = {
    ...
    LADSU?: FloatWithAggregatesFilter<"Lease"> | number
  ...
  export type LeaseUpdateInput = {
    ...
    LADSU?: FloatFieldUpdateOperationsInput | number
