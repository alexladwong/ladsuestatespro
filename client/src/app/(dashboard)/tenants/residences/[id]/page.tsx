        ...
        <div className="flex justify-between items-center">
          <div className="xl:flex">
            ...
            <div className="font-semibold">
              {new Date(curLADSULease.startDate).toLocaleDateString()}
            </div>
          </div>
          ...
          <div className="xl:flex">
            ...
            <div className="font-semibold">
              {new Date(curLADSULease.endDate).toLocaleDateString()}
            </div>
          </div>
          <div className="border-[0.5px] border-primary-300 h-4" />
          <div className="xl:flex">
...
const Residence = () => {
  ...
  const curLADSULease = leases?.find(
    ...
    <div className="dashboard-container">
      <div className="w-full mx-auto">
        <div className="md:flex gap-10">
          {curLADSULease && (
            <ResidenceCard property={property} curLADSULease={curLADSULease} />
          )}
          <PaymentMethod />
        </div>
