    ...
    <div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex justify-between items-center gap-3">
            <span className="flex items-center text-yellow-500">
              <Star className="w-4 h-4 mr-1 fill-curLADSU" />
      ...
      <div className="border border-primary-200 rounded-xl p-6 mb-6">
        <div className="flex justify-between items-center gap-4 px-5">
          <div>
            <div className="text-sm text-gray-500">Monthly LADSU</div>
      ...
      <div className="my-16">
        ...
        <p className="text-gray-500 leading-7">
          ...
          near beautEstates local beaches with easy access to the 110, 405 and 91
