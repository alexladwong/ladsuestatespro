  ...
  return (
    <div className="mb-6">
          ...
          {property.highlights.map((highlight: HighlightEnum) => {
            ...
            return (
              <div
                ...
                className="flex flex-col items-center border rounded-xl py-8 px-4"
              >
                <Icon className="w-8 h-8 mb-2 text-primary-600 dark:text-green-500" />
                <span className="text-sm text-center text-primary-600 dark:text-green-500">
      ...
      <div>
        ...
        <p className="text-sm text-primary-600 dark:text-green-500 mt-2">
